...
public class OrderService {
    ...
    public void addOrder(Integer itemId, Integer memberId) {
    ...
    public Map getOrders(Integer itemId, Integer memberId) {
        ...
        if (!itemSellerId.equals(memberId)) {
    ...
    public void deleteOrder(Integer itemId, Integer memberId) {
        //구매자 신청 존재 및 구매자 신청 삭제 권한 확인
        orderMapper.selectOrder(itemId, memberId).orElseThrow(IllegalArgumentException::new);
